...
#else
	#define E3_ASSERT(_expr) (static_cast <bool> (_expr) ? void (0) : e3_assert_internal(__FILE__, __LINE__, __FUNCTION__, #_expr));
	#define E3_ABORT(_message) (e3_assert_internal(__FILE__, __LINE__, __FUNCTION__, _message));
#endif
